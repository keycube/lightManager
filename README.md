...
|--|--|--|--|--|
| matrix | [list[list[Any]]](https://docs.python.org/3/library/typing.html) |  |  | A matrix of integer |
...
| Parameter | Type | Optional | Default | Description |
|--|--|--|--|--|
| matrix | [list[list[int]]](https://docs.python.org/3/library/typing.html) |  |  | A matrix of integer |
...
|--|--|--|--|--|
| matrix | [list[list[Any]]](https://docs.python.org/3/library/typing.html) |  |  | A matrix of integer |
| n | [int](https://docs.python.org/3/library/typing.html) |  |  | an integer corresponding to the number of rotations by 90 |
...
| Parameter | Type | Optional | Default | Description |
|--|--|--|--|--|
| key | [int](https://docs.python.org/3/library/typing.html) |  |  | the integer corresponding to a key value |
...
| Parameter | Type | Optional | Default | Description |
|--|--|--|--|--|
| tab | [int](https://docs.python.org/3/library/typing.html) |  |  | the view centered on a face matrix |
| actual | [list[tuple(int)]](https://docs.python.org/3/library/typing.html) |  |  | list of coordinates pixel to update |
| previous | [list[list[tuple(int)]]](https://docs.python.org/3/library/typing.html) | Yes | [] | sequence of all list of all steps of update |
| counter | [int](https://docs.python.org/3/library/typing.html) | Yes | 0 | steps of the effect |
